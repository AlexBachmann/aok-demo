/**
 * All Credit belongs to Ben Nadel (@BenNadel)
 * See: http://www.bennadel.com/blog/3025-creating-custom-dom-and-host-event-bindings-in-angular-2-beta-6.htm
 * 
 * ALL COMMENTS BELOW ARE FROM BEN
 *
...
import { ɵDomEventsPlugin as DomEventsPlugin } from '@angular/platform-browser';

@Injectable()
export class OutsideClickEvent extends DomEventsPlugin {
	documentEventMap = {
		"clickOutside": "click",
